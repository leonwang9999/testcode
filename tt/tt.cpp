...
static inline std::string getExamplePath()
{
    ...
    return filePath.substr( 0, filePath.length() - std::string("tt.cpp").length());
}

/// Example Database
static const std::string filename_example_db3 = getExamplePath() + "/example1.db3";
/// Image
...
int main ()
{
    ...
    try
    {
        ...
        SQLite::Database    db(filename_example_db3, SQLITE_OPEN_READWRITE|SQLITE_OPEN_CREATE);  //->w r SQLITE_OPEN_READONLY
    ...
    {
        // Open a database file in readonly mode
        SQLite::Database    db(filename_example_db3);  //-> w r SQLITE_OPEN_READONLY
        std::cout << "SQLite database file '" << db.getFilename().c_str() << "' opened successfully\n";
    ...
    try
    {
        ...
        SQLite::Database    db("test1.db3", SQLITE_OPEN_READWRITE|SQLITE_OPEN_CREATE);
        std::cout << "SQLite database file '" << db.getFilename().c_str() << "' opened successfully\n";
